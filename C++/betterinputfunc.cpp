...
get_int_range(first,last)
	Forces te user to enter an integer within a
	specified range
	first is either a minimum or maximum acceptavle value
	last is the corresponding other end of the range
	either a maximum or minimum value
	Returns an accceptavle value from the user
	*/

int get_int_range(int first, int  last) {
	// If the latger number is provided first.
